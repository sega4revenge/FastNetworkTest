...
import sega.fastnetwork.test.lib.SliderTypes.Indicators.PagerIndicator;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.AccordionTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.BackgroundToForegroundTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.BaseTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.CubeInTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.DefaultTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.DepthPageTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.FadeTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.FlipHorizontalTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.FlipPageViewTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.ForegroundToBackgroundTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.RotateDownTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.RotateUpTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.StackTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.TabletTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.ZoomInTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.ZoomOutSlideTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Transformers.ZoomOutTransformer;
import sega.fastnetwork.test.lib.SliderTypes.Tricks.FixedSpeedScroller;
import sega.fastnetwork.test.lib.SliderTypes.Tricks.InfinitePagerAdapter;
import sega.fastnetwork.test.lib.SliderTypes.Tricks.InfiniteViewPager;
import sega.fastnetwork.test.lib.SliderTypes.Tricks.ViewPagerEx;

/**
 * SliderLayout is compound layout. This is combined with {@link sega.fastnetwork.test.lib.SliderTypes.Indicators.PagerIndicator}
 * and {@link sega.fastnetwork.test.lib.SliderTypes.Tricks.ViewPagerEx} .
 *
