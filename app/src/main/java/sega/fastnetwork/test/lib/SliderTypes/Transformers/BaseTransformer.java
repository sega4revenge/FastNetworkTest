 ...
 *
 * BaseTransformer implement {@link sega.fastnetwork.test.lib.SliderTypes.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link sega.fastnetwork.test.lib.SliderTypes.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link sega.fastnetwork.test.lib.SliderTypes.Animations.BaseAnimationInterface}
 * work.
 *
