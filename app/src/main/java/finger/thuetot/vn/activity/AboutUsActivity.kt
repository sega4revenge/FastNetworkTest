...
class AboutUsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aboutPage = AboutPage(this)
                ...
                .addItem(Element().setTitle(resources.getString(R.string.txt_version) + " " +packageManager.getPackageInfo(packageName,0).versionName))
                //                .addItem(adsElement)
                .addGroup(resources.getString(R.string.txt_Connect_with_us))
                .addEmail("thuetot.vn@gmail.com",resources.getString(R.string.txt_Connect_mail))
                .addFacebook("thuetot.vn",resources.getString(R.string.txt_Connect_fb))
                .addPlayStore("finger.thuetot.vn",resources.getString(R.string.txt_Connect_store))
                .addWebsite("http://thuetot.vn/",resources.getString(R.string.txt_Connect_website))
